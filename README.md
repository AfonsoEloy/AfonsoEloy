...
Most of my work lives in private repositories pending paper acceptance, which will mostly be made public upon acceptance. In the meantime, I'm happy to discuss robotics, autonomy systems, and software design in general.
